    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_feature', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='collections', to='shop.mainfeature', verbose_name='Features')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='discount.basediscount', verbose_name='Discount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted at')),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='discount.basediscount', verbose_name='Discount')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promtions', to='shop.product')),
                ('promotion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promotionitems', to='shop.promotion')),
            ],
            options={
                'abstract': False,
            },
