    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('DO', 'DirectPrice'), ('DP', 'DiscountOff')], default='DP', max_length=2, verbose_name='Mode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted at')),
                ('payment_status', models.CharField(choices=[('N', 'Not Paid'), ('P', 'Pending'), ('S', 'Shipping'), ('D', 'Delivered'), ('F', 'Failed')], default='N', max_length=1, verbose_name='Payment Status')),
