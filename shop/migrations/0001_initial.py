    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted at')),
                ('key', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop.featurekey')),
                ('value', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop.featurevalue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('key', models.CharField(max_length=10, verbose_name='Value')),
